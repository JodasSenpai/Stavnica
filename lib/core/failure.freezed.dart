...
class _$ServerError with IFailure implements ServerError {
  const _$ServerError([this.message = "Server error"]);
...
abstract class ServerError implements Failure, IFailure {
